...
export function Hero() {
  return (
    <div 
      id="hero"
      className="bg-gradient-to-br from-blue-900 to-indigo-800 dark:from-blue-950 dark:to-indigo-900 text-white py-20"
    >
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row">
            <button
              className="bg-white text-blue-900 dark:bg-blue-100 dark:text-blue-900 px-8 py-4 rounded-full 
            ...
            <button
              className="bg-blue-700 dark:bg-blue-800 text-white px-8 py-4 rounded-full 
