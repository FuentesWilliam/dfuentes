      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="p-6 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-center shadow-lg hover:shadow-2xl"
            >
              <div
                className="inline-block p-3 bg-blue-100 dark:bg-blue-900 rounded-full text-blue-600 dark:text-blue-400 mb-4"
              >
                {feature.icon}
              </div>
